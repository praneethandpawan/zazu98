...
import 'package:maptest/Maps/shops.dart';
...
class user_current_locatation extends StatefulWidget {
  const user_current_locatation({Key? key}) : super(key: key);

  @override
  State<user_current_locatation> createState() => _user_current_locatationState();
}

class _user_current_locatationState extends State<user_current_locatation> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
...
class home_map extends StatefulWidget {
  const home_map({Key? key}) : super(key: key);

  @override
  State<home_map> createState() => _home_mapState();
}
